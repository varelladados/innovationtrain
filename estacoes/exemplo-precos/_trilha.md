...
Uma estação de exemplo sobre um assunto de trabalho: acompanhar o preço dos
...
Ela é irmã de `estacoes/exemplo` (cozinha e fotografia). As duas usam o mesmo
...
- `_indice.md` — a porta de entrada desta estação
