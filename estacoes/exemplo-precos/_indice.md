...
> **Esta estação é um exemplo**, e é feita para ser mexida. A loja, os
...
>
> Ela existe ao lado de `estacoes/exemplo` (cozinha e fotografia) para
...
**Isso é o estado normal.** Uma estação onde tudo avançou não existe.
...
desmembramento), e é a maioria dos casos numa estação de verdade: ideia
...
1. Numa estação de verdade, **cada projeto é um repositório git próprio**
   ...
   estação, para o exemplo caber num clone só.
