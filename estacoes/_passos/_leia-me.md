# _passos — a trilha das estações de exemplo

Cada pasta aqui é **a estação inteira num estado adiante**. "Avançar a
trilha", no app, não promove nada: ele restaura o próximo instantâneo daqui.

É de propósito que não haja motor de promoção. Numa estação de verdade a
...
o `_registro.md` da estação com o de cada instantâneo. Mexeu à mão? A trilha
diz "fora dos passos", que é a resposta honesta.

Só uma estação que declara `estado_inicial` pode ser restaurada — e uma
estação sua não declara.
