...
data: 2026-09-02
estagio: 5
origem: 26.08.30-FUN-001-busca-pelo-que-tem-em-casa-5c2e
tipo: app
status: em andamento
---
...
> abrir nesta pasta.
>
> **Isto é um exemplo.** Ele existe para mostrar como uma estação fica quando
...
Veio de `26.08.30-FUN-001-busca-pelo-que-tem-em-casa-5c2e` — a funcionalidade que o
originou, e a primeira linha do backlog —, que veio de
`26.08.28-IDE-001-receita-pela-despensa-b3a9`, que veio de uma nota, que veio de um braindump no ônibus —
a cadeia inteira está no `_registro.md` desta estação.
...
- `_indice.md` da estação — a porta de entrada
