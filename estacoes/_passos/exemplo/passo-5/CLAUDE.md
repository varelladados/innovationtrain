...
> **Isto é a estação de exemplo que começa vazia.** Só há capturas: quem
> faz o trem andar é quem está usando. A irmã dela,
> `estacoes/exemplo-precos`, já vem povoada em todos os estágios — uma
> existe para ser dirigida, a outra para ser lida.
>
> **Reiniciar devolve esta pasta ao estado de origem** (`estacao.py
...
Uma estação da Central: capturas → notas → ideias → funcionalidades → projetos. Toda ideia
